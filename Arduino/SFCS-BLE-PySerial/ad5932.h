...
fr
       ...
       @param[in] nincr Number of the equency increments. Minimum is 2 and maximum is 4095.
    ...
    */
    ...
    int capRead(uint8_t pin_num, uint8_t smooth_degree);
    const int bufferSize(uint8_t smooth_degree);
